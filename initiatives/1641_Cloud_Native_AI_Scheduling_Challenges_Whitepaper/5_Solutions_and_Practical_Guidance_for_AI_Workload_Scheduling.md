...
These tools provide higher-level abstractions for AI workflows:
...
| Queue Management | \- | Armada, KAI, Kueue, Slinky, Volcano, YuniKorn  | Airflow, Argo Workflows, Flyte | Both | Core capability of batch schedulers |
...
| Topology Awareness (Node) | Topology Manager (NUMA), DRA CPU Driver (CPU topology) | HAMi, KAI, Kueue, Slinky, Volcano | \- | Both | GPU interconnect awareness varies |
...
* Gang scheduling was historically the most critical capability gap in default Kubernetes and is now being addressed natively as of v1.35 (alpha), with further enhancements in v1.36.
...
2. Use the appropriate job abstractions (MPIJob, PyTorchJob, TrainJob, etc.) rather than raw pods.  
...
5. The ecosystem is maturing. Projects like Kueue, Slinky, Volcano, and KAI Scheduler are production-ready. Dynamic Resource Allocation reached GA in Kubernetes 1.34. The tools exist—the question is choosing and integrating them.  
